...
public class Bai03 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtNumber1, javax.swing.GroupLayout.DEFAULT_SIZE, 152, Short.MAX_VALUE)
        ...
        jLabel5.setText("Căn bậc 2 của a:");

        txtCan.setEditable(false);

        jLabel6.setText("Lũy thừa (a^b):");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        txtCan.setText(String.format("%.1f", Math.sqrt(number1)));
        txtLuythua.setText(String.format("%.1f", Math.pow(number1, number2)));
        if(number1 >= number2){
            txtMax.setText(String.format("%.1f", number1));
            txtMin.setText(String.format("%.1f", number2));
        } else{
            txtMax.setText(String.format("%.1f", number2));
            txtMin.setText(String.format("%.1f", number1));
        }
